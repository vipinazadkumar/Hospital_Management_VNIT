...
public class Reception extends JFrame {
    Reception(){
        ...
        panel.setBackground(new Color(226, 239, 225));
        add(panel);

        JPanel panel1 = new JPanel();
        panel1.setLayout(null);
        panel1.setBounds(5,5,1525,150);
        panel1.setBackground(new Color(186, 192, 192));
        add(panel1);


        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/doctor.jpg"));
        Image image = i1.getImage().getScaledInstance(150,150,Image.SCALE_DEFAULT);
        ImageIcon i2 = new ImageIcon(image);
        JLabel label = new JLabel(i2);
        label.setBounds(1300,-50,250,250);
        panel1.add(label);

        ImageIcon i = new ImageIcon(ClassLoader.getSystemResource("icon/hc.jpg"));
        Image image1 = i.getImage().getScaledInstance(1000,800,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(image1);
        JLabel label1 = new JLabel(i3);
        label1.setBounds(200,0,1000,800);
        panel.add(label1);
...
//        panel1.add(label1);
        ...
        JButton btn1 = new JButton("Add New Student");
        ...
        JButton btn4 = new JButton("All Doctor Info");
        ...
        JButton btn5 = new JButton("Student Info");
        btn5.setBounds(30,58,200,30);
        ...
        JButton btn9 = new JButton("Search Department");
